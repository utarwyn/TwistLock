...
class FormJoueur extends JFrame
{
	...
	private void preparer( )
	{
		...
		intelligenceJ1 = new JCheckBox( "Intelligent" , true );
		intelligenceJ2 = new JCheckBox( "Intelligent" , true );
		intelligenceJ3 = new JCheckBox( "Intelligent" , true );
		intelligenceJ4 = new JCheckBox( "Intelligent" , true );
		...
		textFieldJ1 = new JTextField( "J1" );
		textFieldJ2 = new JTextField( "J2" );
		textFieldJ3 = new JTextField( "J3" );
		textFieldJ4 = new JTextField( "J4" );
	...
	private boolean verification( )
	{
		...
		//intelligent
		if( intelligenceJ1.isSelected( ) && textFieldJ1.getText( ).equals( "" ) && intelligenceJ2.isSelected( ) &&
		    textFieldJ2.getText( ).equals( "" ) && intelligenceJ3.isSelected( ) && textFieldJ3.getText( ).equals( "" ) &&
		    intelligenceJ4.isSelected( ) && textFieldJ4.getText( ).equals( "" ) )
		{
			bOk = false;
